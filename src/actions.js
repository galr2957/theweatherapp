...
export const requestCities = (cityName) => (dispatch) => {
  ...
  fetch('http://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=GGqVXPf9g4xzyUl2jPGxaiSsprYLSFXM&q='+cityName).then(response => response.json())
...
export const requestOneDayForcast = (cityKey) => (dispatch) => {
  ...
  fetch('http://dataservice.accuweather.com/currentconditions/v1/'+ cityKey +'?apikey=GGqVXPf9g4xzyUl2jPGxaiSsprYLSFXM').then(response => response.json())
...
export const requestFiveDaysForcast = (cityKey) => (dispatch) => {
  ...
  fetch('http://dataservice.accuweather.com/forecasts/v1/daily/5day/'+ cityKey +'?apikey=GGqVXPf9g4xzyUl2jPGxaiSsprYLSFXM&metric=true').then(response => response.json())
